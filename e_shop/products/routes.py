...
def get_category(id):
    ...
    return render_template('products/index.html', get_cat_prod=get_cat_prod,
                           brands=brands(),
                           categories=categories(),
                           get_cat=get_cat)
...
def updatebrand(id):
    ...
    return render_template('products/addbrand.html',
                           title='Udate brand', brands='brands',
...
def addproduct():
    ...
    if request.method == "POST"and 'image_1' in request.files:
        ...
        image_3 = photos.save(request.files.get('image_3'),
                              name=secrets.token_hex(10) + ".")
        addproduct = Addproduct(name=name, price=price, discount=discount,
                                stock=stock, colors=colors, desc=desc,
    ...
    return render_template('products/addproduct.html', form=form,
                           title='Add a Product', brands=brands,
                           categories=categories)
